jQuery(document).ready(function(Rs){
	...
	if( Rs('.cd-bg-video-wrapper').length > 0 ) {
		var videoWrapper = Rs('.cd-bg-video-wrapper'),
		...
		if( mq == 'desktop' ) {
			...
			var	videoUrl = videoWrapper.data('video'),
				video = Rs('<video loop><source src="'+videoUrl+'.mp4" type="video/mp4" /><source src="'+videoUrl+'.webm" type="video/webm" /></video>');
